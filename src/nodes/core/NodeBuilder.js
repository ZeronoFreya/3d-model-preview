...
NodeBuilder.prototype = {
    ...
    build: function(vertex, fragment) {
        ...
        if (this.requires.worldNormal) {
            ...
            this.addVertexFinalCode(
                "vWNormal = ( modelMatrix * vec4( objectNormal, 0.0 ) ).xyz;",
            );
        }
    ...
    include: function(node, parent, source) {
        ...
        var includes = (includesStruct[this.shader] =
                ...
                if (nodeCandidate.isNode) {
                    ...
                    switch (nodeCandidate.mapping) {
                        ...
                        case THREE.CubeUVRefractionMapping:
                            return new TextureCubeNode(
                                new TextureNode(nodeCandidate),
                            );
    ...
    getTextureEncodingFromMap: function(map, gammaOverrideLinear) {
        gammaOverrideLinear =
            gammaOverrideLinear !== undefined
                ? gammaOverrideLinear
                : this.context.gamma &&
                  (this.renderer ? this.renderer.gammaInput : false);
