...
TempNode.prototype.build = function(builder, output, uuid, ns) {
    ...
    if (this.isShared(builder, output)) {
        ...
        if (builder.parsing) {
            ...
            data.name =
                data.name ||
                Node.prototype.build.call(this, builder, output, uuid);

            return data.name;
        } else if (
            !this.isShared(builder, type) ||
            (!builder.optimize || data.deps == 1)
        ) {
            return Node.prototype.build.call(this, builder, output, uuid);
        }
        ...
        if (name) {
            ...
            name = TempNode.prototype.generate.call(
                this,
                builder,
                output,
                uuid,
...
TempNode.prototype.getUuid = function(unique) {
    var uuid =
        unique || unique == undefined
            ? this.constructor.uuid || this.uuid
            : this.uuid;
